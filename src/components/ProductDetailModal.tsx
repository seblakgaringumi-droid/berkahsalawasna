...
import { X, Plus, Minus, Check, ShoppingBag, AlertTriangle, Store, ShieldCheck } from 'lucide-react';
          ...
          {!isOutOfStock && currentCartQty === 0 && (
            <div className="pt-2 border-t border-slate-100 flex items-center justify-between">
              ...
              <div className="flex items-center bg-slate-100 border border-slate-200 rounded-xl p-1">
                <button
                  onClick={() => setSelectedQty(Math.max(step, selectedQty - step))}
                ...
                <button
                  onClick={() => setSelectedQty(Math.min(stock, selectedQty + step))}
          ...
          {currentCartQty > 0 && !isOutOfStock && (
            <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-2xl flex items-center justify-between text-xs">
              ...
              <div className="flex items-center gap-1.5">
                <button
                  onClick={() => onUpdateQuantity(product.id, currentCartQty - step)}
                ...
                <button
                  onClick={() => onUpdateQuantity(product.id, Math.min(stock, currentCartQty + step))}
          ...
          <div className="pt-2">
            {isOutOfStock ? (
              ...
              >
                ...
                <span>+ TAMBAH KE KERANJANG ({formatRupiah(product.selling_price * selectedQty)})</span>
              </button>
            )}
          </div>
        </div>
